...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.2.0/css/font-awesome.min.css'><link rel="stylesheet" href="login.css">
			...
			<div id="login">
				<form class="form">
					<p class="fieldset">
						...
						<input class="full-width has-padding has-border" id="signin-email" name="signin-email" type="email" placeholder="E-mail">
